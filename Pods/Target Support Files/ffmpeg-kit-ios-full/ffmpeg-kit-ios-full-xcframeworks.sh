...
install_xcframework "${PODS_ROOT}/ffmpeg-kit-ios-full/ffmpegkit.xcframework" "ffmpeg-kit-ios-full" "framework" "ios-arm64_x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavcodec.xcframework" "ffmpeg-kit-ios-full" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
...
install_xcframework "${PODS_ROOT}/ffmpeg-kit-ios-full/libavutil.xcframework" "ffmpeg-kit-ios-full" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/ffmpeg-kit-ios-full/libswresample.xcframework" "ffmpeg-kit-ios-full" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_x86_64-maccatalyst" "ios-arm64"
